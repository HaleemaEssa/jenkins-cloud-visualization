...
df4h=df4h.dropna()
#df4h=df4h.drop_duplicates(subset=['Sound', 'Flame', 'Humidity', 'Temperature'])
...
date_format = mpl_dates.DateFormatter('%d-%m') # y m d for year.... %H-%M-%S for hour, minutes,and second
...
plt2.tight_layout()
plt2.title('Daily-Resampled_Humidity_data Plotting')
plt2.xlabel('Date')
...
date_formath = mpl_dates.DateFormatter('%d-%m')
plt2h.gca().xaxis.set_major_formatter(date_formath)
plt2h.tight_layout()
plt2h.title('10Min-Resampled_Humidity_data Plotting')
plt2h.xlabel('Date')
...
plt3.tight_layout()
plt3.title('Daily-Resampled_Temperature_data Plotting')
plt3.xlabel('Date')
...
plt3h.tight_layout()
plt3h.title('10Min-Resampled_Temperature_data Plotting')
plt3h.xlabel('Date')
...
p.legend()
p.tight_layout()
p.title('Daily-Resampled_Temperature_and_Humidity_data Plotting')
p.xlabel('Date')
...
ax1.legend()
ax1.set_title('Daily-Resampled_Temperature_data Plotting')
#        ax1.set_xlabel('Date')
ax1.set_ylabel('Temperature')
ax2.legend()
ax2.set_title('Daily-Resampled_Humidity_data Plotting')
       # ax2.set_xlabel('Date')
ax2.set_ylabel(' Humidity')
ax3.legend()
ax3.set_title('Daily-Resampled_Temperature & Humidity_data Plotting')
ax3.set_xlabel('Date')
ax3.set_ylabel('Temperature &  Humidity ')
pl.tight_layout()
...
ax1.legend()
ax1.set_title('10Min-Resampled_Temperature_data Plotting')
#        ax1.set_xlabel('Date')
ax1.set_ylabel('Temperature')
ax2.legend()
ax2.set_title('10Min-Resampled_Humidity_data Plotting')
       # ax2.set_xlabel('Date')
ax2.set_ylabel(' Humidity')
ax3.legend()
ax3.set_title('10Min-Resampled_Temperature & Humidity_data Plotting')
ax3.set_xlabel('Date')
ax3.set_ylabel('Temperature &  Humidity ')
plh.tight_layout()
